...
public enum HttpStatusEnum {
	...
	ADD_ZERO_PRICE(403,"AES_AP_E015","Product item with zero price is not allowed","Product item with zero price is not allowed"),
	ADD_INTERNAL_SERVER_ERROR(500,"500","Internal Server Error","Internal Server Error"),
	//Create Cart
//	CREATE_INVALID_CART_PARM(400,"AES_CC_E001","Invalid query parameter",""),
	...
	CREATE_ZERO_PRICE(403,"AES_CC_E005","Product item with zero price is not allowed","Product item with zero price is not allowed"),
	//Update Cart
	...
	UPDATE_ZERO_PRICE(403,"AES_UP_E010","Product item with zero price is not allowed","Product item with zero price is not allowed"),
	//Prices
...
//	PRICES_NOT_AVAILABLE(403,"AES_PP_E009","Unavailable seats exists in the cart","Some of the product items in the cart is not available anymore, please remove them and retry"),
	...
	COMMON_CONNECTION_TIMEOUT(500,"AES_GE_E003","Connection timeout","");
