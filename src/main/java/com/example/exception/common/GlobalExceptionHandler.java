...
import com.example.exception.constant.HttpSourceEnum;
import com.example.exception.constant.HttpStatusEnum;
...
public class GlobalExceptionHandler {
	...
	private static Logger logger = (Logger) LoggerFactory.getLogger(GlobalExceptionHandler.class);
    ...
    public ResponseEntity<Object> defaultErrorHandler(HttpServletRequest req, Exception e) throws Exception {
        ...
        else if(e instanceof DataAccessResourceFailureException || e instanceof CannotCreateTransactionException)
        {        	
        ...
        {    
        	...
        	errorBodyVo.setCode(((ApplicationException) e).getMessage());
        	httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
        }
